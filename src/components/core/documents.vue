                ...
                for( let i = 0; i < this.files.length; i++ )
                {
                    if ( /\.(jpe?g|png|gif)$/i.test( this.files[i].content.name ) ) {
                        ...
                        this.$nextTick(function(){
                            ...
                            if( /\.(pdf)$/i.test( this.files[i].content.name ))
                            {
                                this.$refs['preview'+parseInt(i)][0].src = '/img/pdf.png';

                            } else if (/\.(doc|docx)$/i.test( this.files[i].content.name ))
                            {
                                this.$refs['preview'+parseInt(i)][0].src = '/img/doc.png';

                            }else if (/\.(csv|xls|xlsx)$/i.test( this.files[i].content.name ))
                            {
                                this.$refs['preview'+parseInt(i)][0].src = '/img/excel.png';
                                ...
                                <div class="col-lg-4 mb-2" v-for="(file, key) in files"  :class="['dimmer' , file.id === 3  ? 'active' : '']">
                                    ...
                                    <div class="dimmer-content">
                                        <div style="position: relative;min-height: 200px;max-height: 200px">
                                            ...
                                            <div v-if="file.id === 1" class="d-flex align-items-center justify-content-center text-white" style="position:absolute;top: 0;bottom: 0;right: 0;left:0;background-color: rgba( 119, 36, 109  , 0.7 )">
                                        ...
                                        <div class="col-lg-4 mb-3" :key="item.id" v-for="item in data.content.data">
                                            <div :class="['border' , item.cover ? 'border-primary' : '']">
                                                ...
                                                <div class="card-body border-top">
                                                    <div class="tx-11">
                                                        <div><strong>{{ item.f_name }}</strong></div>
